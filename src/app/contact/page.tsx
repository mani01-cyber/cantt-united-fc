...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-white pt-24 pb-16 relative">
      {/* Background Ambience */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 italic tracking-tighter mb-4">GET IN <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-emerald-400">TOUCH</span></h1>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-start">
          ...
          <div className="space-y-6">
            <GlassCard className="flex items-start gap-6 !p-8">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-900 mb-2">Club Headquarters</h3>
                <p className="text-slate-600 leading-relaxed">Garrison Sports Complex<br />Lahore Cantt, Pakistan</p>
              </div>
            </GlassCard>

            <GlassCard className="flex items-start gap-6 !p-8 hover:border-accent/50">
            ...
            <GlassCard className="flex items-start gap-6 !p-8 hover:border-blue-400/50">
            ...
            <GlassCard className="flex items-start gap-6 !p-8 hover:border-pink-500/50">
          ...
          <div className="relative">
            ...
            <div className="glass-panel p-8 md:p-10 rounded-3xl border border-slate-200 relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid md:grid-cols-2 gap-5">
                    <div className="space-y-1">
                      <label className="text-xs font-bold text-slate-600 uppercase tracking-widest ml-1">Name</label>
                      <input
                        type="text"
                        name="name"
                        value={formData.name}
                        ...
                        required
                        className="w-full bg-slate-50/50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all placeholder:text-slate-600"
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-bold text-slate-600 uppercase tracking-widest ml-1">Subject</label>
                    <input
                      type="text"
                      name="subject"
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-bold text-slate-600 uppercase tracking-widest ml-1">Message</label>
                    <textarea
                      name="message"
                      ...
                      required
                      rows={5}
                      className="w-full bg-slate-50/50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all placeholder:text-slate-600 resize-none"
        ...
        {/* Map */}
        <div className="mt-20 glass-panel p-4 rounded-3xl h-[450px] relative overflow-hidden group hover:border-primary/50 transition-colors">
          <iframe
