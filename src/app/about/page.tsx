    ...
    <main className="min-h-screen bg-white pt-24 pb-16 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20 animate-fade-in-up">
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 italic tracking-tighter mb-4">OUR <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">LEGACY</span></h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
          <div className="space-y-6">
            ...
            <h2 className="text-4xl font-bold text-slate-900">The Pride of Lahore</h2>
          ...
          <div className="relative">
            ...
            <GlassCard hoverEffect={false} className="relative !p-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-24">
          ...
          <GlassCard hoverEffect={false} className="group hover:border-accent/50 transition-colors">
          ...
          <GlassCard hoverEffect={false} className="group hover:border-pink-500/50 transition-colors">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-12">Club Leadership</h2>
        ...
        <div className="glass-panel rounded-3xl p-12 text-center relative overflow-hidden">
          ...
          <h2 className="text-4xl font-black text-slate-900 mb-6 uppercase italic">Join the <span className="text-primary">Revolution</span></h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/join" className="px-8 py-3 bg-primary hover:bg-violet-500 text-slate-900 font-bold rounded-full transition-colors shadow-lg shadow-primary/20">
              Join the Squad
            </Link>
            <Link href="/squad" className="px-8 py-3 bg-slate-100/80 hover:bg-slate-200/80 text-slate-900 font-bold rounded-full transition-colors border border-slate-200">
              Meet the Team
            </Link>
          </div>
        </div>
