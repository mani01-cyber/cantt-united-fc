          ...
          <div className="grid gap-4 mt-8">
            <div className="glass-panel p-6 rounded-2xl flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm">Access to professional coaching staff and state-of-the-art facilities.</p>
              </div>
            </div>
            <div className="glass-panel p-6 rounded-2xl flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm">Comprehensive evaluation of your technical skills, fitness, and game intelligence.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          {success ? (
            <div className="glass-panel p-10 rounded-3xl text-center border-green-500/30">
              ...
              <button onClick={() => setSuccess(false)} className="px-8 py-3 bg-slate-200/80 hover:bg-slate-300/80 rounded-full text-slate-900 font-bold transition-all">
                Register Another Player
              </button>
            </div>
          ) : (
            <div className="glass-panel p-8 md:p-10 rounded-3xl border border-slate-200 shadow-2xl relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary via-accent to-primary" />

              <h2 className="text-2xl font-bold text-slate-900 mb-6">Trial Application</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-slate-50/50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all placeholder:text-slate-600"
                    placeholder="NAME"
                    autoComplete="name"
                  />
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full bg-slate-50/50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all"
                    >
